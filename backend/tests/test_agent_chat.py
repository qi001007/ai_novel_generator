...
class SteppedClient:
    ...
    def stream_messages(self, task_type, messages, temperature=0.6, usage_out=None, model=None, tools=None, reasoning_out=None, channels=False, tool_calls_out=None):
